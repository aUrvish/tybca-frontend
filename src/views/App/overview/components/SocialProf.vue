<template>
    <div>
        <div class="p-4 bg-[#e7e6fb] rounded-md">
            ...
            <h4 class="mt-1 text-center font-bold font-sans text-[20px]">Total Students</h4>
            <p class="text-center font-bold font-sans text-[30px]">1000</p>
        </div>
        <div class="p-4 bg-[#f9e5ea] rounded-md">
            ...
            <h4 class="mt-1 text-center font-bold font-sans text-[20px]">Total Teacher</h4>
            <p class="text-center font-bold font-sans text-[30px]">26</p>
        </div>
        <div class="p-4 bg-[#dfedf7] rounded-md">
            <div class="w-fit p-4 rounded-full mx-auto bg-[#1b8be3]">
                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" class="h-8 w-8 fill-white"
                    viewBox="0 0 448 512">
                    <path
                        d="M96 0C43 0 0 43 0 96V416c0 53 43 96 96 96H384h32c17.7 0 32-14.3 32-32s-14.3-32-32-32V384c17.7 0 32-14.3 32-32V32c0-17.7-14.3-32-32-32H384 96zm0 384H352v64H96c-17.7 0-32-14.3-32-32s14.3-32 32-32zm32-240c0-8.8 7.2-16 16-16H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16zm16 48H336c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16s7.2-16 16-16z" />
                </svg>
            </div>
            <h4 class="mt-1 text-center font-bold font-sans text-[20px]">Total Courses</h4>
            <p class="text-center font-bold font-sans text-[26px]">15</p>
        </div>
