<template>
    ...
    <div class="grid grid-cols-5 gap-4 mt-10">
        <div
            class="max-w-2xl sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto border rounded-md" v-for="i in 20" :key="i">
            <div class="rounded-t-lg h-32 overflow-hidden">
                <img class="object-cover object-top w-full"
                    src='../../../assets/images/back-img2.jpg'
                    alt='Mountain'>
            </div>
