...
const { getProfilesAction } = useAuthStore();
...
<template>
    <div class="min-h-[320px] -mx-4 -mt-6 profile-thubnil md:p-10 px-4 pt-10 bg-no-repeat object-cover bg-center bg-cover">
        <div class="flex justify-between flex-wrap gap-4 items-start">
            <div class="flex items-center">
                ...
                <div class="w-20 border-[3px] rounded-full overflow-hidden border-white aspect-square">
                    <img :src="getStorage +user.profileImg" class="w-full h-full object-cover" v-if="user.profileImg" alt="avtar">
        ...
        <div class=" flex md:justify-end justify-between mt-24 ">
            ...
            <Btn class="text-white bg-green-400 font-medium rounded-md text-base flex items-center px-4 py-1.5 text-center" @click="router.push(`edit/${user.id}`)" v-if="auth.user.role_id == 0">
