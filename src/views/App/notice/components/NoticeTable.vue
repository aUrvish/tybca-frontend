...
const { noticeGetAllAction, noticeRemoveAction, noticeChangeStatusAction, getNoticeSeacherAction, setClearLatestNotice } = useNoticeStore();
        ...
        <div>
            ...
            <div class="bg-white relative border sm:rounded-lg overflow-hidden">
                <div class="flex items-center justify-between p-4 border-b">
                    <h1 class="text-[20px] font-bold">Notice</h1>
                ...
                <div class="overflow-x-auto">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex justify-between items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue cursor-pointer w-4"
                                            viewBox="0 0 512 512" @click="goTourl(notice.uri)">
                                            <path
                    ...
                    <p v-if="noticeList.data?.length == 0" class="px-4 py-2 border-b" >No Data Found</p>
                </div>
