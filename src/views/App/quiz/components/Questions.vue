...
const removeOption = (queIndex, optIndex) => {
    questions.value[queIndex].option.splice(optIndex, 1);
}
                ...
                <div class="p-5 border border-l-[5px] border-l-primary bg-white rounded-lg  cursor-move group">
                    ...
                    <div class="grid grid-cols-2 gap-5 mt-10">
                        <div class="flex items-center justify-between border rounded-md py-3 px-4 group-option"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                viewBox="0 0 384 512" @click="removeOption(index)">
                                <path
                                    d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" />
                            </svg>
                        </div>
                        <div class="flex items-center cursor-pointer" @click="addOption(index)">
                            <svg xmlns="http://www.w3.org/2000/svg" class="max-w-5 fill-gray-400" viewBox="0 0 512 512">
                                <path
                    ...
                    <div class="mt-10 flex items-center justify-end">
                        <div class="flex items-center">
                            <input type="checkbox" class="h-5 w-5 mr-3" id="require1" v-model="questions[index].isRequire">
