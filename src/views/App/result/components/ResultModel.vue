    ...
    <div
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 w-full max-w-screen-md h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow ">
                ...
                <!-- Modal body -->
                <div class="p-4 md:p-5 space-y-4 bg-white" ref="resultEle">
                    ...
                    <p style="text-align: center;"><span style="font-size: 18pt;"><strong>Ventures - Examination
                                2024-25</strong></span></p>
                    ...
                    <table style="border-collapse: collapse; width: 100%; height: 111.953px;" border="1">
                        ...
                        <tbody>
                            <tr style="height: 22.3906px;">
                                ...
                                <td style="height: 22.3906px;"><strong>280028</strong></td>
                            </tr>
                            <tr style="height: 22.3906px;">
                                <td style="height: 22.3906px;">Candidate Name</td>
                                <td style="height: 22.3906px;"><strong>Jone Deo</strong></td>
                            </tr>
                            <tr style="height: 22.3906px;">
                                <td style="height: 22.3906px;">Candidate Email</td>
                                <td style="height: 22.3906px;"><strong>jone@example.com</strong></td>
                            </tr>
                            <tr style="height: 22.3906px;">
                                <td style="height: 22.3906px;">Candidate Mobile No.</td>
                                <td style="height: 22.3906px;"><strong>9797899788</strong></td>
                            </tr>
                            <tr style="height: 22.3906px;">
                                <td style="height: 22.3906px;">Candidate Address</td>
                                <td style="height: 22.3906px;"><strong>Surat, India</strong></td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="flex items-center justify-between p-4 md:p-4 border-t border-gray-200 rounded-b ">
                    ...
                    <a :href="downloadUrl" download class="py-2.5 px-5 ms-3 text-sm font-medium text-white focus:outline-none bg-primary rounded-lg hover:text-blue-700 focus:z-10">Download</a>
                </div>
            </div>
        </div>
    </div>
