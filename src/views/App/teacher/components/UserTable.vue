            ...
            <div class="bg-white relative border sm:rounded-lg overflow-hidden">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex justify-between items-center gap-2">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-success cursor-pointer w-4"
                                            viewBox="0 0 512 512" v-if="auth.user.role_id == 0" @click="router.push(`/profile/edit/${teacher.id}`)">
                                            <path
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-red-400 cursor-pointer w-4"
                                            viewBox="0 0 448 512" v-if="auth.user.role_id == 0" @click="selectedId = teacher.id">
                                            <path
                ...
                <nav class="flex justify-between items-center space-y-0 p-4" aria-label="Table navigation">
                    ...
                    <ul class="inline-flex items-stretch -space-x-px">
                        <li>
                            <button
                                :class="teacherList.prev_page_url ? 'cursor-pointer hover:bg-gray-100 hover:text-gray-700' : 'bg-slate-100 cursor-auto'" @click="teacherList.prev_page_url ? pagination-- : ''"
                        ...
                        <li>
                            <button
                                :class="teacherList.next_page_url ? 'cursor-pointer hover:bg-gray-100 hover:text-gray-700' : 'bg-slate-100 cursor-auto'" @click="teacherList.next_page_url ? pagination++ : ''"
