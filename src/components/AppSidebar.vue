...
<template>
    <aside
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform  bg-white border-r border-gray-200 lg:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
                ...
                <li>
                    <RouterLink :to="{ name: 'App' }"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-6 h-6 text-gray-500 group-hover:text-gray transition duration-75" fill="currentColor"
            ...
            <ul class="space-y-2 mt-2 border-t pt-2">
                ...
                <li>
                    <RouterLink :to="{ name: 'Result' }"
                        class="flex items-center p-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-100 group">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-5 h-5 text-gray-500 group-hover:text-gray transition duration-75" fill="currentColor">
                            <path
            ...
            <ul class="space-y-2 mt-2 border-t pt-2">
                <li>
                    <RouterLink :to="{ name: 'StudentList' }"
                        ...
                        <span class="ml-3.5 group-hover:text-gray">Users</span>
                    </RouterLink>
                </li>
                <li>
