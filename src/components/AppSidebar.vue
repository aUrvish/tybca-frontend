            ...
            <ul class="space-y-2 mt-2 border-t pt-2">
                ...
                <li>
                    <RouterLink :to="{ name: 'Payment' }"
                        class="flex items-center p-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-100 group">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-5 h-5 text-gray-500 group-hover:text-gray transition duration-75" fill="currentColor" height="16"
                            width="18" viewBox="0 0 576 512">
                            <path
                                d="M64 32C28.7 32 0 60.7 0 96v32H576V96c0-35.3-28.7-64-64-64H64zM576 224H0V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V224zM112 352h64c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm112 16c0-8.8 7.2-16 16-16H368c8.8 0 16 7.2 16 16s-7.2 16-16 16H240c-8.8 0-16-7.2-16-16z" />
                        </svg>
                        <span class="ml-3.5 group-hover:text-gray">Profit</span>
                    </RouterLink>
                </li>
            </ul>
