...
<template>
    <div
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 w-full max-w-md h-auto">
            <!-- Modal content -->
            <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
                ...
                <svg class="text-gray-400 w-11 h-11 mb-3.5 mx-auto"
                ...
                <div class="flex justify-center items-center space-x-4">
                    ...
                    <button type="submit" @click="$emit('delete')"
                        class="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:outline-none flex items-center gap-2">
                        Yes, I'm sure

                        <svg aria-hidden="true" v-if="isLoading" class="w-5 h-5 text-white animate-spin fill-red-600"
